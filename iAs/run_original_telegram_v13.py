# -*- coding: utf-8 -*-
"""
run_original_telegram_v13.py — Motor de IA V13 (Consenso caracter-por-caracter + Alertas reales)
══════════════════════════════════════════════════════════════════════════════
    ...
    def _procesar(self, track_id, vehicle_roi, veh_bbox, frame_num, mejor_area_ref):
        ...
        if mejor['plate']:
            ...
            if mejor['area'] >= parea:
                ...
                try: cv2.imwrite(f"plates/{frame_num}_{track_id}_{mejor['plate']}_V13.png", mejor['img'])
                except: pass
...
def main():
    ...
    print("🤖 Cargando V13 — Consenso caracter-por-caracter + Alertas reales...")
    import torch
    ...
    while cap.isOpened():
        ...
        if frame is not None:
            cv2.imshow('Detection and Tracking V13', frame)
